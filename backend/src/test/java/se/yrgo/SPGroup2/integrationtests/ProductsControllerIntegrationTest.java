...
//    private ProductController productController;
    ...
    private PostgreSQLContainer underTest;

    @BeforeEach
    public void setUp() {
        // Assume that we have Redis running locally?
        underTest = new PostgreSQLContainer("postgres:latest")
    ...
    public void getAllProductsTest() throws Exception {
        ...
        String databaseName = underTest.getDatabaseName();
...
//        List<Product> jackets = productController.getAllProducts()stc.stream()
